<section class="testimonials">
    <div class="background bg-img bg-fixed section-padding pb-0" data-background="images/AdobeStock_201875917_Preview.jpeg"
         data-overlay-dark="2">
        <div class="container">
            <div class="row">
                <!-- Reservation -->
                <div class="col-md-5 mb-30 mt-30">
                    ...
                    <div class="reservations mb-30">
                        ...
                        <div class="text">
                            <p class="color-1">Reservation</p> <a class="color-1" href="tel:+33783704244">07 83 70 42 44</a>
                        </div>
                    </div>
                        ...
                        <div class="booking-inner clearfix">
                            <form action="rooms2.html" class="form1 clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn-form1-submit mt-15">Check Availability
                                        </button>
                                    </div>
                                </div>
                            </form>
