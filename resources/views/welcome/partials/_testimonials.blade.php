<section class="testimonials">
    <div class="background bg-img bg-fixed section-padding pb-0" data-background="the_cappa/img/slider/2.jpg"
         data-overlay-dark="3">
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="testimonials-box">
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <span class="quote"><img src="the_cappa/img/quot.png" alt=""></span>
                                ...
                                <div class="info">
                                    <div class="author-img"><img src="the_cappa/img/team/4.jpg" alt=""></div>
                            ...
                            <div class="item">
                                ...
                                <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the
                                    ...
                                    space, mus nellentesque habitan.</p>
                                <div class="info">
                                    <div class="author-img"><img src="the_cappa/img/team/1.jpg" alt=""></div>
                                    <div class="cont"><span><i class="star-rating"></i><i class="star-rating"></i><i
                                                class="star-rating"></i><i class="star-rating"></i><i
                                                class="star-rating"></i></span>
                            ...
                            <div class="item">
                                ...
                                <p>Hotel dapibus asue metus the nec feusiate eraten miss hendreri net ve ante the
                                    ...
                                    space, mus nellentesque habitan.</p>
                                <div class="info">
                                    <div class="author-img"><img src="the_cappa/img/team/5.jpg" alt=""></div>
                                    <div class="cont"><span><i class="star-rating"></i><i class="star-rating"></i><i
                                                class="star-rating"></i><i class="star-rating"></i><i
                                                class="star-rating"></i></span>
